...
@cesium163-extends/measure is a measurement tool based on Cesium, which supports distance and area measurement and is easy to use.
...
Import the `@cesium163-extends/measure` module in your project, then instantiate the corresponding measuring class for measurement.
...
import { AreaMeasure } from "@cesium163-extends/measure";
...
```typescript
import { Viewer } from "cesium";
import { AreaSurfaceMeasure } from "@cesium163-extends/measure";
...
```typescript
import { Viewer } from "cesium";
import { DistanceMeasure } from "@cesium163-extends/measure";
...
```typescript
import { Viewer } from "cesium";
import { DistanceSurfaceMeasure } from "@cesium163-extends/measure";
